...
class Hull(DynamicObject, VisualObject):
    def __init__(self, sprite="StandardHull.png", max_speed=120, max_rot_speed=60, length=70, width=50, armor=80,
                 lvl=0):
...
class StandardHull(Hull):
    def __init__(self, lvl=0, **kwargs):
        super().__init__(sprite="StandardHull.png", max_speed=150, max_rot_speed=90,
                         length=70, width=50, armor=100, lvl=lvl, **kwargs)
